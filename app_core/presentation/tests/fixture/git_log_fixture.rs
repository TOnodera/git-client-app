...
impl GitLogCommandTrait for GitLogCommandErrorFixture1 {
    ...
    fn execute(&self, option: GitLogCommandOption) -> GitLogCommandOutput {
        ...
        let output = r#"
0cbdaf6b5211d36df10a578b621e63eab3bc52a4 6bec089d8d748eb1a800955bac06597f1fd22414 19c871de65be6334404cb7d26c7b7bed04ad8c00 [t.onodera] t.onodera.1.2.1.5@gmail.com [] [t.onodera] t.onodera.1.2.1.5@gmail.com [Fri, 27 Jan 2023 21:51:24 +0900] [git logの具体的なパーザーを実装]
"#
        .as_bytes()
        .to_vec();
        Ok(output)
...
pub struct GitLogCommandErrorFixture2;
impl GitLogCommandTrait for GitLogCommandErrorFixture2 {
    fn new() -> Self {
        Self
    }
    fn execute(&self, option: GitLogCommandOption) -> GitLogCommandOutput {
        // author_date,commit_dateがないデータは不正扱い
        let output = r#"
0cbdaf6b5211d36df10a578b621e63eab3bc52a4 6bec089d8d748eb1a800955bac06597f1fd22414 19c871de65be6334404cb7d26c7b7bed04ad8c00 [t.onodera] t.onodera.1.2.1.5@gmail.com [Fri, 27 Jan 2023 21:51:24 +0900] [t.onodera] t.onodera.1.2.1.5@gmail.com [] [git logの具体的なパーザーを実装]
"#
        .as_bytes()
        .to_vec();
        Ok(output)
...
pub struct GitLogCommandErrorFixture3;
impl GitLogCommandTrait for GitLogCommandErrorFixture3 {
    fn new() -> Self {
        Self
    }
    fn execute(&self, option: GitLogCommandOption) -> GitLogCommandOutput {
